  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative w-full p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-takeat-primary-default/20 [&:has([aria-selected].day-outside)]:bg-takeat-primary-default/10 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 focus:outline-none focus:ring-2 focus:ring-takeat-primary-default"
        ),
