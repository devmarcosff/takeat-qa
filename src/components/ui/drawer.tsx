...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-50 bg-takeat-neutral-darker/40 blur-3xl", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="mx-auto mt-4 h-2 w-[100px] rounded-full bg-muted z-50 hidden" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
